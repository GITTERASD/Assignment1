                ...
                <div className="col-lg-8">
                    <div className="card rounded-4 shadow-lg">
                        ...
                        <div className="card-body">
                            ...
                            <input className="form-control" type="number" min="40" max="220"
                                value={settings.bpm}
                            ...
                            <div className="mt-3">
                                <label className="form-label">Backing Vocal Group</label>
                            ...
                            <div className="mt-3">
                                <label className="form-label">Backing Volume: {settings.backingVol.toFixed(2)}</label>
                                <input className="form-range" type="range" min="0" max="1" step="0.01"
                            ...
                            <div className="mt-3">
                                ...
                                <input className="form-range" type="range" min="-12" max="12" step="1"
